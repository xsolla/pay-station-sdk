...
export class CardNumberComponent extends TextComponent {
    ...
    protected connectedCallback(): void {
        ...
        this.subscriptions.push(this.postMessagesClient.listen<{ cardType: string }>(
        ...
        this.subscriptions.push(this.postMessagesClient.listen<{ cardBinCountry?: string }>(
            ...
            (res) => {
                ...
                this.dispatchEvent(new CustomEvent(EventName.cardBinCountryChanged, eventOptions));
            },
        ));
    }

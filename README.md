...
This project uses automated releases with [Release Please](https://github.com/google-github-actions/release-please-action) and Slack notifications.

📚 **Documentation:**
- [**Release Flow**](./.github/RELEASE_FLOW.md) - Complete release process with visual diagram
- [**Slack Setup**](./.github/SLACK_SETUP.md) - How to configure Slack notifications
...
2. Merge to `main` - Release Please will create a Release PR automatically
3. Merge the Release PR - Package will be published to NPM automatically
4. Get notifications in Slack (if configured) for:
   - 📝 Release PR created
   - ✅ Release published successfully
   - ❌ Release failed (with error details)
...
- **commit-msg**: Validates commit message format using [Commitlint](https://commitlint.js.org/)
